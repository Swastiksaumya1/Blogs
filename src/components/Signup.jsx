  ...
  return (
    <div className="flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-xl rounded-2xl p-8 border border-zinc-200 dark:border-zinc-800/50 shadow-xl shadow-black/5 dark:shadow-black/20 transition-colors">
          <div className="mb-6 flex justify-center">
            <Logo width="140px" />
          </div>
          <h2 className="text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-1 transition-colors">Create your account</h2>
          <p className="text-center text-sm text-zinc-500 dark:text-zinc-400 mb-8 transition-colors">
          ...
          <form onSubmit={handleSubmit(create)}>
            <div className='space-y-4'>
              ...
              <div>
                ...
                />
                {!errors.password && (
                  <p className="text-zinc-500 dark:text-zinc-600 text-xs mt-1.5 pl-1 transition-colors">
